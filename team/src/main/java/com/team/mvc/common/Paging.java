package com.team.mvc.common;

public class Paging {

   public static String getPaging(String path, int nowPage, int recordPerPage, int totalRecord, int bType, String sel, String search) {
      ...
      if ( beginPageOfBlock < pagePerBlock ) {
         ...
         sb.append("<a href='" + path + "?bType=" + bType + "&sel=" + sel + "&search=" + search + "&currentPage=" + (beginPageOfBlock - 1) + "'>◀</a>&nbsp;&nbsp;");
      }
      ...
      for ( int page = beginPageOfBlock; page <= endPageOfBlock; page++ ) {
         if ( page == nowPage ) {
            ...
            sb.append("<a href='" + path + "?bType=" + bType + "&sel=" + sel + "&search=" + search + "&currentPage=" + (page) + "'>" + page + "</a>&nbsp;&nbsp;");
         }
      }
      // "&bType=" + bType + 
      ...
      if ( endPageOfBlock == totalPage ) {
         ...
         sb.append("<a href='" + path + "?bType=" + bType + "&sel=" + sel + "&search=" + search + "&currentPage=" + (endPageOfBlock + 1) + "'>▶</a>");
      }
   ...
   public static String getPaging2(String path, int nowPage, int recordPerPage, int totalRecord, int userIdx, String userId) {
         ...
         if ( beginPageOfBlock < pagePerBlock ) {
            ...
            sb.append("<a href='" + path + "?userIdx=" + userIdx + "&userId=" + userId + "&currentPage=" + (beginPageOfBlock - 1) + "#marker'>◀</a>&nbsp;&nbsp;");
         }
         ...
         for ( int page = beginPageOfBlock; page <= endPageOfBlock; page++ ) {
            if ( page == nowPage ) {
               ...
               sb.append("<a href='" + path + "?userIdx=" + userIdx + "&userId=" + userId + "&currentPage=" + (page) + "#marker'>" + page + "</a>&nbsp;&nbsp;");
            }
         }
         // "&bType=" + bType + 
         ...
         if ( endPageOfBlock == totalPage ) {
            ...
            sb.append("<a href='" + path + "?userIdx=" + userIdx + "&userId=" + userId + "&currentPage=" + (endPageOfBlock + 1) + "#marker'>▶</a>");
         }
