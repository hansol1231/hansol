...
<jsp:include page="../layout/header.jsp">
    <jsp:param value="예약관리 페이지" name="title" />
</jsp:include>
...
<script type="text/javascript">
    function addCalendar() {
        swal({
            title: "예약 링크를 추가합니다.",
            text: "예약은 현재 달부터 3개월이 추가됩니다.",
            type: "info"
        }).then(function() {
            location.href = "adminAddCalendar";
        });
    }
    ...
    function removeCalendar() {
        swal({
            title: "예약 링크를 삭제합니다.",
            text: "현재 날짜까지 삭제가 진행됩니다.",
            type: "info"
        }).then(function() {
            location.href = "adminRemoveCalendar";
        });
    }
</script>
...
<div class="cal_t">
    ...
    <hr>
    <div>
        <input type="button" class="btn btn-success" value="예약 링크 추가" onclick="addCalendar()"> <!-- 월에 해당하는 일마다 링크 3개씩 추가 -->
        &nbsp;&nbsp;
        <input type="button" class="btn btn-default" value="전체 예약 현황 보기" onclick="location.href='goReserveList'">
        &nbsp;&nbsp;
        <input type="button" class="btn btn-warning" value="지난 예약 링크 삭제" onclick="removeCalendar()"> <!-- 현재일 기준, 지난 예약 데이터를 삭제 -->
    </div>
    <script type="text/javascript">
        buildCalendar(); //
    </script>
